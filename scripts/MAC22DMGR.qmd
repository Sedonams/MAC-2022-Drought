...
```{r,warning=FALSE,message=FALSE}
MAC22_CLEANED <- read.csv("data/MAC22_cleaned.csv")
MAC22_DMGR <- read.csv("data/mac22_dmgr.csv") 
MAC22_ORIGINS <- read.csv("data/mac22_origins.csv")
MAC22_OUT <- read.csv("data")
```
